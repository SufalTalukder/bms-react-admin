export const SITE_TITLE = "Admin Panel";
...
export const AUTH_USER_FAILED_TO_FETCH_USERS = `Failed to fetch auth users.`;
...
export const AUTH_USER_FILL_ALL_REQUIRED_FIELDS = `Please fill all required fields.`;
export const AUTH_USER_INVALID_EMAIL_ADDRESS = `Invalid email address.`;
export const AUTH_USER_INVALID_PHONE_NUMBER = `Invalid phone number. It should be 10 digits.`;
...
export const AUTH_USER_ADDED_SUCCESSFULLY = `Auth user added successfully!`;
export const AUTH_USER_UPDATED_SUCCESSFULLY = `Auth user updated successfully!`;
export const AUTH_USER_FAILED_TO_SAVE = `Failed to save auth user.`;
export const AUTH_USER_DELETED_SUCCESSFULLY = `Auth user deleted successfully!`;
export const AUTH_USER_FAILED_TO_DELETE = `Failed to delete auth user.`;
