            ...
            <div className="dashboard-layout">
                <main id="main" className="main">
                    <div className="pagetitle d-flex justify-content-between align-items-center">
                        <h1 className="mb-0">Manage Languages</h1>
                                            ...
                                            <tbody id="tcategory">
                                                <tr id="loader-row">
                                                    <td colSpan="7" className="text-center py-4">
                                                        ...
                                                        <strong>&nbsp; Languages(s) Loading...</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                ...
                <div className="modal-dialog modal-dialog-scrollable" style={{ maxHeight: "65vh" }}>
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="addModalTitle">Add Language</h5>
                            <h5 className="modal-title" id="updateModalTitle" style={{ display: "none" }}>Update Language</h5>
                                    ...
                                    <div className="card-body">
                                        <div className="row mb-3 pt-2">
                                            ...
                                            <div className="col-sm-12">
                                                <input type="text" className="form-control" name="addLanguageName" value={language} onChange={(e) => setLanguage(e.target.value)} maxLength={100} autoComplete="new-name" required />
                                            </div>
                                        </div>
                                        <div className="row mb-3">
                                            <label className="col-sm-12 col-form-label">Active *</label>
                                            <div className="col-sm-12">
                                                <select className="form-select" name="addLanguageActive" value={languageActive} onChange={(e) => setLanguageActive(e.target.value)} required>
