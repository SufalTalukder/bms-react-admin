                                            ...
                                            <tbody id="tcategory">
                                                <tr id="loader-row">
                                                    <td colSpan="7" className="text-center py-4">
                                                        ...
                                                        <strong>&nbsp; Categorie(s) Loading...</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                ...
                <div className="modal-dialog modal-dialog-scrollable" style={{ maxHeight: "65vh" }}>
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="addModalTitle">Add Category</h5>
                            <h5 className="modal-title" id="updateModalTitle" style={{ display: "none" }}>Update Category</h5>
                                ...
                                <div className="card-body">
                                    <div className="row mb-3">
                                        ...
                                        <div className="col-sm-12">
                                            <input type="text" className="form-control" name="addCategoryName" id="addCategoryName" maxLength="100" autoComplete="new-name" required />
                                        </div>
                                    </div>
                                    <div className="row mb-3">
                                        <label className="col-sm-12 col-form-label">Active *</label>
                                        <div className="col-sm-12">
                                            <select className="form-select" name="addCategoryActive" id="addCategoryActive" required>
